...
openai.api_key = "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"
engine = pyttsx3.init()
...
def generate_response(prompt):
    try:
        ...
        st.error(f"Error occurred during response generation: {e}")
        return None
    ...
    if action == "Retrieve Patient Details":
        ...
        with sr.Microphone() as source:
            ...
            if transcription:
                ...
                prompt = f"Retrieve details for patient {transcription}"
